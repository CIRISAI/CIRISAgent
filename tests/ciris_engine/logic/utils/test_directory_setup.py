...
class TestSetupApplicationDirectories:
    ...
    def test_fix_existing_directory_permissions(self):
    ...
    def test_insufficient_disk_space_fails_fast(self):
    ...
    def test_cannot_create_directory_fails_fast(self):
    ...
    def test_cannot_write_to_directory_fails_fast(self):
...
class TestErrorMessages:
    ...
    def test_disk_space_error_message(self):
