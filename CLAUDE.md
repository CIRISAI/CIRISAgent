...
| **OpenRouter** | `https://openrouter.ai/api/v1` | `meta-llama/llama-4-scout` | **REJECTED 2026-09-04** (see `MODEL_CAPABILITIES.json` rejected_models): malformed structured output on the epistemic-humility conscience. Was the QA model (live as of 2026-04-28). Routed to DeepInfra under the hood. Key at `~/.openrouter_key`; usage gate is $100/week ($0.0000018/call observed). |
