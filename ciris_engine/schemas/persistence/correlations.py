...
class CorrelationRequestData(BaseModel):
    ...
    parameters: Dict[str, Any] = Field(default_factory=dict, description="Additional parameters")  # NOQA - Extensible request parameters
    headers: Dict[str, str] = Field(default_factory=dict, description="Request headers")
    metadata: Dict[str, Any] = Field(default_factory=dict, description="Request metadata")  # NOQA - Extensible request metadata
...
class CorrelationResponseData(BaseModel):
    ...
    metadata: Dict[str, Any] = Field(default_factory=dict, description="Response metadata")  # NOQA - Extensible response metadata
...
class ChannelInfo(BaseModel):
    ...
    metadata: Dict[str, Any] = Field(default_factory=dict, description="Additional channel metadata")  # NOQA - Extensible channel metadata
