...
def main():
    ...
    parser.add_argument(
        "--include-dirs",
        nargs="+",
        default=["ciris_engine", "ciris_adapters", "ciris_ios", "ciris_sdk"],
        help="Directories to include in manifest (for --build), default: ciris_engine ciris_adapters ciris_ios ciris_sdk",
    )
