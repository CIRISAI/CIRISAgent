"""
AppleNotes Tool Service for CIRIS.
...
class AppleNotesToolService:
    """
    AppleNotes tool service providing skill-based guidance.
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None) -> None:
        ...
        self._call_count = 0
        logger.info("AppleNotesToolService initialized")

    async def start(self) -> None:
        """Start the service."""
        logger.info("AppleNotesToolService started")

    async def stop(self) -> None:
        """Stop the service."""
        logger.info("AppleNotesToolService stopped")
    ...
    def _build_tool_info(self) -> ToolInfo:
        ...
        return ToolInfo(
            ...
            category="skill",
            when_to_use="""When you need to manage apple notes via the `memo` cli on macos (create, view, edit, delete, search, move, and export...""",
            requirements=ToolRequirements(
                binaries=[
                    BinaryRequirement(name="memo"),
                ],
                platforms=["darwin"],
            ),
            install_steps=[
            ...
            tags=["skill", "clawdbot", "apple_notes", "cli"],
            version="1.0.0",
        )
