...
def create_stream_update_from_step_results(
    ...
    for raw_result in step_results:
        thought_data = ThoughtStreamData(
            ...
            step_category=get_step_metadata(StepPoint(raw_result.get("step_point", StepPoint.FINALIZE_ACTION)))["category"],
            ...
            progress_percentage=calculate_progress_percentage([], StepPoint(raw_result.get("step_point", StepPoint.FINALIZE_ACTION))),
