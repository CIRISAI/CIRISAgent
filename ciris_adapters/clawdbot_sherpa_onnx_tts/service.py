"""
SherpaOnnxTts Tool Service for CIRIS.
...
class SherpaOnnxTtsToolService:
    """
    SherpaOnnxTts tool service providing skill-based guidance.
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None) -> None:
        ...
        self._call_count = 0
        logger.info("SherpaOnnxTtsToolService initialized")

    async def start(self) -> None:
        """Start the service."""
        logger.info("SherpaOnnxTtsToolService started")

    async def stop(self) -> None:
        """Stop the service."""
        logger.info("SherpaOnnxTtsToolService stopped")

    def _build_tool_info(self) -> ToolInfo:
        """Build the ToolInfo with all skill documentation."""
        return ToolInfo(
            name="sherpa_onnx_tts",
            description="""Local text-to-speech via sherpa-onnx (offline, no cloud)""",
            ...
            tags=["skill", "clawdbot", "sherpa_onnx_tts", "api"],
            version="1.0.0",
        )
