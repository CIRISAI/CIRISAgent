...
class TmuxToolService:
    """
    Tmux tool service providing skill-based guidance.
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None) -> None:
        ...
        self._call_count = 0
        logger.info("TmuxToolService initialized")

    async def start(self) -> None:
        """Start the service."""
        logger.info("TmuxToolService started")

    async def stop(self) -> None:
        """Stop the service."""
        logger.info("TmuxToolService stopped")
