...
**Seed reference**: `SEED_DIMENSIONS.yaml` v1.1, dimension `D13` ([source](https://github.com/CIRISAI/ciris-response-magnifica-humanitas/blob/main/SEED_DIMENSIONS.yaml))
