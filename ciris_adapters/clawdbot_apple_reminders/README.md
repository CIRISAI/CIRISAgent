...
```bash
# Load the adapter
python main.py --adapter api --adapter clawdbot_apple_reminders
```
...
*Source: /home/emoore/clawdbot_lessons/clawdbot/skills/apple-reminders/SKILL.md*
