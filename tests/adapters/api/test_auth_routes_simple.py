...
from ciris_engine.logic.adapters.api.routes.auth import _determine_user_role, _load_oauth_config, get_oauth_callback_url
...
class TestOAuthConfig:
    ...
    def test_load_oauth_config_google_success(self, mock_read_text, mock_exists):
        ...
        mock_read_text.return_value = (
            '{"google": {"client_id": "test-google-id", "client_secret": "test-google-secret"}}'
        )
    ...
    def test_load_oauth_config_github_success(self, mock_read_text, mock_exists):
        ...
        mock_exists.return_value = True
        mock_read_text.return_value = (
            '{"github": {"client_id": "test-github-id", "client_secret": "test-github-secret"}}'
        )
    ...
    def test_load_oauth_config_discord_success(self, mock_read_text, mock_exists):
        ...
        mock_exists.return_value = True
        mock_read_text.return_value = (
            '{"discord": {"client_id": "test-discord-id", "client_secret": "test-discord-secret"}}'
        )
