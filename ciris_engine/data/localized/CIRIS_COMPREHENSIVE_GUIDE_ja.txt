...
これらには適切な責任分離を伴う別個の専用モジュールが必要です。
...
## プライバシー: Consensual Evolution Protocol
...
*CIRISエージェントは、監査可能で倫理的な決定を下すために存在します。透明性は構造的であり、願望的ではありません。自律性は対称的に尊重されます。ツールは利用可能な場合に使用されます。制限は実際の場合に述べられます。*
