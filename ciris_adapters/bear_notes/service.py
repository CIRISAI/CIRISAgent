"""
BearNotes Tool Service for CIRIS.
...
class BearNotesToolService:
    """
    BearNotes tool service providing skill-based guidance.
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None) -> None:
        ...
        self._call_count = 0
        logger.info("BearNotesToolService initialized")

    async def start(self) -> None:
        """Start the service."""
        logger.info("BearNotesToolService started")

    async def stop(self) -> None:
        """Stop the service."""
        logger.info("BearNotesToolService stopped")
    ...
    def _build_tool_info(self) -> ToolInfo:
        ...
        return ToolInfo(
            ...
            tags=["skill", "ciris", "bear_notes", "cli"],
            version="1.0.0",
        )
