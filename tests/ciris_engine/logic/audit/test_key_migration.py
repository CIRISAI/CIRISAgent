...
class TestAuditKeyMigration:
    ...
    def test_init(self, temp_db, mock_time_service):
        """Test initialization."""
        migration = AuditKeyMigration(temp_db, mock_time_service)
    ...
    def test_get_current_key_info_no_key(self, temp_db, mock_time_service):
    ...
    def test_get_current_key_info_with_rsa_key(self, populated_db, mock_time_service):
        """Test getting key info with existing RSA key."""
        migration = AuditKeyMigration(populated_db, mock_time_service)
    ...
    def test_load_all_entries(self, populated_db, mock_time_service):
    ...
    def test_load_all_entries_empty(self, temp_db, mock_time_service):
    ...
    def test_resign_entries(self, populated_db, mock_time_service):
    ...
    def test_update_database(self, populated_db, mock_time_service):
    ...
    def test_register_ed25519_key(self, temp_db, mock_time_service):
    ...
    def test_register_ed25519_key_idempotent(self, temp_db, mock_time_service):
    ...
    def test_archive_old_key(self, populated_db, mock_time_service):
    ...
    def test_create_backup(self, populated_db, mock_time_service):
    ...
    def test_verify_chain_integrity_valid(self, populated_db, mock_time_service):
...
class TestMigrateToEd25519:
    ...
    @pytest.mark.asyncio
    async def test_migrate_no_existing_key(self, temp_db, mock_time_service):
    ...
    @pytest.mark.asyncio
    async def test_migrate_already_ed25519(self, temp_db, mock_time_service):
    ...
    @pytest.mark.asyncio
    async def test_migrate_empty_entries(self, temp_db, mock_time_service):
    ...
    @pytest.mark.asyncio
    async def test_migrate_with_entries(self, populated_db, mock_time_service):
...
class TestConvenienceFunction:
    ...
    @pytest.mark.asyncio
    async def test_migrate_audit_key_to_ed25519(self, temp_db, mock_time_service):
        ...
        with patch("ciris_engine.logic.audit.signing_protocol.get_unified_signing_key", return_value=MockUnifiedKey()):
            result = await migrate_audit_key_to_ed25519(temp_db, mock_time_service, backup=False)
