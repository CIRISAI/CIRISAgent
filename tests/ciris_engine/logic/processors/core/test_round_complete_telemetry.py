...
class TestRoundCompleteTelemetry:
    ...
    async def test_round_complete_records_telemetry_with_string_tags(
        self,
        thought_processor_phase_with_telemetry,
        mock_telemetry_service,
        sample_processing_queue_item,
        sample_final_result,
    ):
        ...
        # Execute
        result = await thought_processor_phase_with_telemetry._round_complete_step(
            sample_processing_queue_item, sample_final_result
        )
    ...
    async def test_round_complete_handles_zero_round_number(
        ...
        # Execute
        await thought_processor_phase_with_telemetry._round_complete_step(
            sample_processing_queue_item, sample_final_result
        )
