...
Post-2.9.7 (#896) the dialect module is detection-only: connection-string
parsing plus `placeholder()` / `is_postgresql()` probes. The legacy SQL
translation helpers (upsert, json_extract, pragma, ...) were deleted along
with the SQLite connection layer — ciris-persist owns SQL execution.
"""
...
class TestDialectAdapter:
    """Test DialectAdapter dialect detection functionality."""
