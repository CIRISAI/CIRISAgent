...
from ciris_engine.logic.adapters.api.routes.system.helpers import (
    ...
    determine_server_state,
    get_server_state,
    is_localhost_request,
)
from ciris_engine.logic.adapters.api.routes.system.shutdown import (
...
class TestDetermineServerState:
    ...
    def test_shutting_down_takes_priority(self) -> None:
        ...
        result = determine_server_state(runtime, shutdown_in_progress=True, resume_in_progress=True)
    ...
    def test_resuming_state(self) -> None:
        ...
        runtime = MagicMock()
        runtime._initialized = True
        result = determine_server_state(runtime, shutdown_in_progress=False, resume_in_progress=True)
    ...
    def test_ready_state(self) -> None:
        ...
        runtime = MagicMock()
        runtime._initialized = True
        result = determine_server_state(runtime, shutdown_in_progress=False, resume_in_progress=False)
        assert result == "READY"
    ...
    def test_no_runtime(self) -> None:
        ...
        result = determine_server_state(None, shutdown_in_progress=False, resume_in_progress=False)
        assert result == "INITIALIZING"
...
class TestGetServerState:
    ...
    def test_ready_runtime(self) -> None:
        ...
        result = get_server_state(runtime)
...
class TestCheckResumeBlocking:
    ...
    def test_resume_within_timeout(self) -> None:
        ...
        assert content["resume_timeout_seconds"] == RESUME_TIMEOUT_SECONDS
