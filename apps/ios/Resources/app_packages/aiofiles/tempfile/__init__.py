...
def TemporaryDirectory(suffix=None, prefix=None, dir=None, loop=None, executor=None):
    ...
    return AiofilesContextManagerTempDir(
        _temporary_directory(suffix=suffix, prefix=prefix, dir=dir, loop=loop, executor=executor)
    )
...
async def _temporary_directory(suffix=None, prefix=None, dir=None, loop=None, executor=None):
