...
class ImsgToolService:
    """
    Imsg tool service providing skill-based guidance.
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None) -> None:
        ...
        self._call_count = 0
        logger.info("ImsgToolService initialized")

    async def start(self) -> None:
        """Start the service."""
        logger.info("ImsgToolService started")

    async def stop(self) -> None:
        """Stop the service."""
        logger.info("ImsgToolService stopped")
    ...
    def _build_tool_info(self) -> ToolInfo:
        ...
        return ToolInfo(
            ...
            category="skill",
            when_to_use="""When you need to imessage/sms cli for listing chats, history, watch, and sending.""",
            requirements=ToolRequirements(
                binaries=[
                    BinaryRequirement(name="imsg"),
                ],
                platforms=["darwin"],
            ),
            install_steps=[
